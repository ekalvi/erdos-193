...
# PENDING: freeze these only after the primary L6 construction is complete and
# lattice_t_l6_audit.py has emitted its independent terminal artifact.  Heavy
# mode remains locked while any string begins with PENDING or any required
# positive integer is zero.
EXPECTED_L6_SOURCE_SHA256 = "PENDING_TERMINAL_PRIMARY_L6_SOURCE_SHA256"
EXPECTED_L6_SOURCE_BYTES = 0
EXPECTED_L6_SOURCE_PAYLOAD_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_SOURCE_PAYLOAD_SHA256"
)
EXPECTED_L6_SOURCE_PREFIX_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_PREFIX_SHA256"
)
EXPECTED_L6_SOURCE_SELECTION_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_SELECTION_SHA256"
)
EXPECTED_L6_SOURCE_MAX_FIRST_ORDINAL = 0
EXPECTED_L6_FINAL_POINTS = 0

EXPECTED_L6_AUDIT_CHECKER_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_AUDIT_CHECKER_SHA256"
)
EXPECTED_L6_TERMINAL_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_AUDIT_FILE_SHA256"
)
EXPECTED_L6_TERMINAL_BYTES = 0
EXPECTED_L6_TERMINAL_PAYLOAD_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_AUDIT_PAYLOAD_SHA256"
)
EXPECTED_L6_TERMINAL_ORDERED_POINT_STREAM_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_ORDERED_POINT_STREAM_SHA256"
)
EXPECTED_L6_TERMINAL_FLAT_WORD_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_FLAT_WORD_SHA256"
)
EXPECTED_L6_TERMINAL_POINT_SET_SHA256 = (
    "PENDING_TERMINAL_PRIMARY_L6_POINT_SET_SHA256"
)
