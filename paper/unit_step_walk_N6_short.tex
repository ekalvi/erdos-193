...
\vspace{-5pt}
\caption*{The first 512 vertices of the two planar source walks and an oblique view of the tagged $g_{85}$ lift. Segments are colored by state $0,1,2,3$ in blue, orange, green, and pink. Height is compressed only for display. These finite pictures provide context; the infinite theorem follows from (1)--(3).}
\end{figure}
