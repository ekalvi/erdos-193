...
significant, starting in state $I$.  If the current state is $g$, digit $q_j$
emits one pair of coordinate bits and then updates the state by
\[
...
The state left after the final digit is the terminal state $\sigma(w)$.  It
is the accumulated quadrant transformation, not a point or an additional
coordinate.
